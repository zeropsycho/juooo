...
<title>支付宝 - 网上支付 安全快速！</title>
    <link rel="icon" href="<%=path%>/resource/all_product/images/favicon.ico" type="image/x-icon" />
    <link rel="shortcut icon" href="<%=path%>/resource/all_product/images/favicon.ico" type="image/x-icon" />
...
<!-- uitpl:/component/trackerTime.vm -->
    <!-- FD:231:alipay/tracker/iconfont.vm:START --><!-- FD:231:alipay/tracker/iconfont.vm:2891:tracker/iconfont.schema:iconfont:START -->
<style>
@font-face {
    font-family: "rei";
...
<!-- FD:231:alipay/tracker/iconfont.vm:2891:tracker/iconfont.schema:iconfont:END --><!-- FD:231:alipay/tracker/iconfont.vm:END -->
<script type="text/javascript">
  window._to = { start: new Date() };
</script>

<!-- FD:231:alipay/tracker/monitor.vm:START --><!-- FD:231:alipay/tracker/monitor.vm:2892:tracker/monitor.schema:monitor:START -->
<!-- FD:231:alipay/tracker/sai_seer.vm:START --><!-- FD:231:alipay/tracker/sai_seer.vm:2893:tracker/sai_seer.schema:sai_seer:START -->
<script type="text/javascript">
...
<!-- FD:231:alipay/tracker/sai_seer.vm:2893:tracker/sai_seer.schema:sai_seer:END --><!-- FD:231:alipay/tracker/sai_seer.vm:END --><!-- FD:231:alipay/tracker/monitor.vm:2892:tracker/monitor.schema:monitor:END --><!-- FD:231:alipay/tracker/monitor.vm:END -->
<!-- FD:231:alipay/tracker/seajs.vm:START --><!-- FD:231:alipay/tracker/seajs.vm:2882:tracker/seajs.schema:seajs-静态文件地址:START -->
...
<!-- seajs以及插件 -->
<script charset="utf-8" crossorigin="anonymous" id="seajsnode" onerror="window.monitor && monitor.lost && monitor.lost(this.src)" src="<%=path%>/resource/all_product/js/0ebd1e81121444378fc997ae685694f7.js"></script>
...
seajs.config({
  alias: {
    ...
    'seajs-debug': 'sea<%=path%>/resource/all_product/js/seajs-debug/1.1.1/seajs-debug'
  },
...
<!-- https://github.com/sea<%=path%>/resource/all_product/js/sea<%=path%>/resource/all_product/js/blob/1.3.1/src/plugins/plugin-i18n.js -->
<script>
...
<!-- FD:106:alipay/tracker/tracker_time.vm:START --><!-- FD:106:alipay/tracker/tracker_time.vm:784:tracker_time.schema:全站 tracker 开关:START --><script charset="utf-8" crossorigin="crossorigin" src="<%=path%>/resource/all_product/js/alipay.light.base-1.8.js"></script>
...
<script charset="utf-8" src="<%=path%>/resource/all_product/js/49813e43862e4545a1ba567030c70860.js"></script>
<script charset="utf-8" src="<%=path%>/resource/all_product/js/rd.js"></script>
...
<!-- FD:106:alipay/tracker/tracker_time.vm:END --><link charset="utf-8" rel="stylesheet" href="<%=path%>/resource/all_product/css/front-old.css" media="all" />
<link charset="utf-8" rel="stylesheet" href="<%=path%>/resource/all_product/css/alice.components.security-core-2.1-src.css" media="all" />
...
<style>
    ...
    .alipay-logo {
        ...
        background-image: url(<%=path%>/resource/all_product/images/t1hhfgxxvexxxxxxxx.png);
    }
</style>
...
(function () {
    ...
    if (ie && ie < 8 && (self.location.href.indexOf("_xbox=true") < 0)) {
        ...
        document.getElementById('kie-setup-IE8').style.backgroundImage = 'url(<%=path%>/resource/all_product/images/jywarebnl.png)';
...
<!-- FD:231:alipay/tracker/um.vm:START --><!-- FD:231:alipay/tracker/um.vm:2886:tracker/um.schema:um-运行降级UMID代码:START -->
...
cimg.src = "https://ynuf.alipay.com/service/clear.png?xt=P58509db6b6fc82a077bb934762527818&xa=";
</script>


<script type="text/javascript" src="<%=path%>/resource/all_product/js/um.js" charset="utf-8"></script>

<script type="text/javascript">
um.init({
    enabled: 1, ratio: 1, timeout: 3000,
    token: 'P58509db6b6fc82a077bb934762527818', timestamp: '90229078585C5B4258496275',
...
<!-- FD:231:alipay/tracker/um.vm:2886:tracker/um.schema:um-运行降级UMID代码:END --><!-- FD:231:alipay/tracker/um.vm:END -->
...
<div id="J_order" class="order-area" data-module="excashier/login/2015.08.01/orderDetail" >
        ...
        <div id="order" data-role="order" class="order order-bow">
                    	...
                    	<input type="hidden" name="_form_token" value="29232e7be6a1f6f77741670e49248bb3b5b54ab2b1cd4189bf5deffad581966eRZ11"/>
                    <input name="orderId" type="hidden" value="6f306e37473449febab5bf45b80a17be.20" id="orderId" />
                    ...
                    <input name="timeoutMillseconds" type="hidden" value="521611" id="J_timeoutMillseconds"/>
                    <input name="timeoutUrl" type="hidden" value="https://excashier.alipay.com:443/standard/timeOutPage.htm?payOrderId=6f306e37473449febab5bf45b80a17be.20" id="J_timeoutUrl"/>
    ...
    <span data-role="J_questionIcon" seed="order-type-detail" style="cursor: pointer;color: #08c;">[?]</span>
                ...
                <span>交易将在<span id="teOrderDelayText">8分钟</span>后关闭，请及时付款！</span>
            </span>
                                    </div>
                ...
                聚橙网
                                            ...
                                            <span class="second short-content">
                                                ...
                                                <span class="payAmount-area" id="J_basePriceArea">
                                                     <strong class=" amount-font-22 ">1170.00</strong> 元
...
<div class="ui-tip ui-question-tip fn-hide" data-role="J_exchangeTip">
            ...
            <a id="J_OrderExtTrigger" class="order-ext-trigger" href="#" seed="order-detail-more" data-role="J_oderDetailMore">
                ...
                <div class="ui-detail fn-hide" data-role="J_orderDetailCnt" id="J-orderDetail">
                    <div class="ajax-Account od-more-cnt fn-clear">
                        <div class="first  long-content">聚橙网</div>
    ...
    <tbody>
        ...
        <input name="oid" type="hidden" value="6f306e37473449febab5bf45b80a17be.20" id="J_orderId" />
        <input name="pid" type="hidden" value="2088911960456571" id="J_partnerId" />
        <input name="pid" type="hidden" value="2018032952254001010" id="J_outBizID" />
        <input name="qrContextId" type="hidden" value="20180329003051122049d8263767191101" id="J_qrContextId" />
...
.area-split {
    ...
    background-image: url(<%=path%>/resource/all_product/images/t1pspfxixsxxxxxxxx.png);
    background-repeat: no-repeat;
}
...
<div id="hidden-input-area" class="fn-hide">
    <input name="qrCode"            type="hidden" value="https://qr.alipay.com/upx05120mu6ozqqbhds82006"          id="J_qrCode" />
    <input name="qrImgUrl"          type="hidden" value="https://mobilecodec.alipay.com/show.htm?code=upx05120mu6ozqqbhds82006"        id="J_qrImgUrl" />
    <input name="qrUseImage" 		type="hidden" value="false" 		id="J_qrUseImage"/>
    <input name="qrContextId"       type="hidden" value="20180329003051122049d8263767191101"     id="J_qrContextId" />
    <input name="qrRenewalURL"      type="hidden" value="https://excashier.alipay.com:443/standard/renewQRCode.json?payOrderId=6f306e37473449febab5bf45b80a17be.20"    id="J_qrRenewalURL" />
    <input name="qrPushCheckURL"    type="hidden" value=""  id="J_qrPushCheckURL" />
    <input name="qrLoopCheckURL"    type="hidden" value="https://excashier.alipay.com:443/standard/queryQRStatus.json?payOrderId=6f306e37473449febab5bf45b80a17be.20"  id="J_qrLoopCheckURL" />
    <input name="qrPaySuccGotoURL"  type="hidden" value="https://unitradeprod.alipay.com:443/acq/cashierReturn.htm?sign=K1iSL1Da5AjPtxzrbkZLOZN9GJ0cPxMtnMw679YyMIX2c61mRCN019JZjnFBIySgXANtaEE%253D&amp;outTradeNo=2018032952254001010&amp;pid=2088911960456571&amp;type=1" id="J_qrPaySuccGotoURL" />
    <input name="qrCheckMode"       type="hidden" value="LOOP"     id="J_qrCheckMode" />
    <input name="qrExpirySeconds"   type="hidden" value="22" id="J_qrExpirySeconds" />
...
<div data-role="qrPayArea" class="qrcode-integration qrcode-area" id="J_qrPayArea">
        ...
        <div class="ft-center qrcode-header-money">1170.00</div>
    </div>
        ...
        <div style="position: relative;display: inline-block;"><canvas width="168" height="168" style="float: left;"></canvas><img src="<%=path%>/resource/all_product/images/T1Z5XfXdxmXXXXXXXX.png" style="position: absolute;top: 50%;left: 50%;width:168px;height:168px;margin-left: -85px;margin-top: -85px"></div></div>

        <div class="qrcode-img-explain fn-clear">
            <img class="fn-left" src="<%=path%>/resource/all_product/images/T1bdtfXfdiXXXXXXXX.png" alt="扫一扫标识" seed="qrcodeImgExplain-tImagesT1bdtfXfdiXXXXXXXX" smartracker="on">
...
<div class="qrguide-area" id="J_qrguideArea" seed="NewQr_animationClick">
    <img src="<%=path%>/resource/all_product/images/t13cpgxf8mxxxxxxxx.png" class="qrguide-area-img active">
    <img src="<%=path%>/resource/all_product/images/t1asfgxdtnxxxxxxxx.png" class="qrguide-area-img background">
</div>
...
<div class="view-switch qrcode-show fn-left" id="J_viewSwitcher" unselectable="on" onselectstart="return false;" seed="NewQr_viewSwitch">
    ...
    <div class="switch-tip switch-qrcode-tip " id="J_tip_qr">
        ...
        <div class="switch-tip-icon-wrapper">
            ...
            <img class="switch-tip-icon-img" src="<%=path%>/resource/all_product/images/t1hhfgxxvexxxxxxxx.png" alt="支付宝图标" width="50" height="17">
        </div>
    ...
    <div class="switch-tip switch-pc-tip fn-hide" id="J_tip_pc">
        ...
        <div class="switch-tip-icon-wrapper">
            ...
            <img class="switch-tip-icon-img" src="<%=path%>/resource/all_product/images/t1z5xfxdxmxxxxxxxx.png" alt="手机支付宝图标" width="30" height="30">
        </div>
        <a class="switch-tip-btn" href="javascript:void(0)">扫一扫付款&nbsp;&gt;</a>
            ...
            <div class="cashier-center-view view-pc fn-left" id="J_view_pc">
                <form action="https://excashier.alipay.com:443/standard/securityPost.json?payOrderId=6f306e37473449febab5bf45b80a17be.20&viewModel=payerPwdLoginViewModel" method="post" id="J_TloginForm">
                    <input type="hidden" name="commonAccountIdentiAuthUrl" value="https://excashier.alipay.com:443/standard/securityRender.phtm?payOrderId=6f306e37473449febab5bf45b80a17be.20&viewModel=payerPwdLoginViewModel"/>
                                        	<input type="hidden" name="_form_token" value="29232e7be6a1f6f77741670e49248bb356a31cb3a1f344c09b84adef3e8ce678RZ11"/>
...
<div class="loginBox">
	...
	<input type="hidden" name="pwdSecurityId" value="web|excashier_payment_pwd_control|2d7e7fa1-79bf-43c1-9103-c34dd2e62fc4RZ11" />
  ...
  (function () {
    ...
    s.sid = "web|excashier_payment_pwd_control|2d7e7fa1-79bf-43c1-9103-c34dd2e62fc4RZ11";
  })();
</script>
<script type="text/javascript" charset="utf-8" crossorigin="anonymous" src="<%=path%>/resource/all_product/js/3bdffe998d314c8b82cfafc6d2863cce.js"></script>
<script type="text/javascript" charset="utf-8" crossorigin="anonymous" src="<%=path%>/resource/all_product/js/d13af67bd0734b3fbcde832466d024e3.js"></script>
    <script charset="utf-8" crossorigin="anonymous" src="<%=path%>/resource/all_product/js/index.js"></script>
  <script>
  light.trackOn = false;
...
<input type="hidden" id="alieditUid" name="alieditUid" value="b26fea500d2009f141ada7a0967ac3ff" />
...
<script>
  light.node('#payPasswd').parent().find('[name=security_activeX_enabled]')[0].value = alipay.security.activeXEnabled;
      ...
      alipay.security.snowden.record('web|excashier_payment_pwd_control|2d7e7fa1-79bf-43c1-9103-c34dd2e62fc4RZ11', {products:'singlePassword'});
    </script>
...
<style type="text/css">
  ...
  div.sixDigitPassword i.active {
    background-image: url("<%=path%>/resource/all_product/images/t1nyjhxalxxxxxxxxx.gif");
    background-repeat: no-repeat;
  ...
  div.sixDigitPassword b {
    ...
    overflow: hidden;
    visibility:hidden;
    background-image: url("<%=path%>/resource/all_product/images/t1sl0fxcbnxxxxxxxx.png");
  }
  ...
  (function(){
    ...
    var renderArr = 'R',
        ...
        options = {
          ...
          id: 'payPasswd',
          prodType: '',
          sid: 'web|excashier_payment_pwd_control|2d7e7fa1-79bf-43c1-9103-c34dd2e62fc4RZ11'
        },
        renderOptions = {
          downloadPath: 'stable',
          ...
          R: {
            ...
            tabindex: "",
            container: "payPasswd_container",
            ksk: '3f37bf9a-52d2-4b67-88f7-608a95cb2826',             useSixDigitPassword: false           },
          C1: {
            id: "edit_payPasswd",
            name: "edit_payPasswd",
            hidnId: "payPasswd",
          ...
          C2: {
            ...
            useKS: true,
            ksk: '3f37bf9a-52d2-4b67-88f7-608a95cb2826'           }
        },
        sensorOptions = {
...
<!-- 页面主体 结束 -->
  ...
  <script type="text/javascript">
    var form_tk = "naAFQ57CkAlWSFTdvIVWMKDnVHLVtasQ";
    var json_ua = null;
  </script>

   <script type="text/javascript" charset="utf-8" src='<%=path%>/resource/all_product/js/ua_excashier_rds_auth.js'></script>

 <!-- CMS:全站公共 cms/安全cms/外部收银台信息采集开始:security/sensorSdk.vm -->
<script src="<%=path%>/resource/all_product/js/index.js"></script>
...
<div   class="fn-hide" data-role="fishing-popup">
    <style>
        ...
        span.btn, span.btn input, span.btn button {
            background-image: url("<%=path%>/resource/all_product/images/187hqtmqdp.png");
    ...
    <div class="anti-fishing">
	    ...
	    <p>您购买的商品为：<span class="ft-break ft-bold ft-red">聚橙网</span>，收款方为：<strong><font color="red">深圳市聚橙演艺联盟票务有限公司</font></strong>，请确认。</p>
...
<input type="hidden" name="commonAgreementUrl" value="https://excashier.alipay.com:443/standard/agreementDetail.phtm?payOrderId=6f306e37473449febab5bf45b80a17be.20&viewModel=standard%3AcommonAgreementViewModel.vm" />
<input type="hidden" name="memoryPayAgreementUrl" value="https://excashier.alipay.com:443/standard/agreementDetail.phtm?payOrderId=6f306e37473449febab5bf45b80a17be.20&viewModel=standard%3AmemoryPayAgreementViewModel.vm" />

<!--[if lt IE 10]>
<script src="<%=path%>/resource/all_product/js/cf47885b44bd44caa7778ea23e226975.js"></script>
<![endif]-->
...
<!-- FD:174:alipay/foot/cliveService.vm:START --><!-- FD:174:alipay/foot/cliveService.vm:1261:cliveService.schema:在线客服配置:START -->
    ...
    try {
        (function () {
            var loadOnlineServer = function() {
                seajs.config({
                    ...
                    alias: {
                        ...
                        'merchantServerConfig': 'https://gw.alipayobjects.com/os/cschannel/DbRQYeGSAKsWrxEkjfJJ.js',
			...
			'defaultDataConfig': 'https://a.alipayobjects.com/u/<%=path%>/resource/all_product/js/201311/1acIoVU1Xx.js',
                        'onlineServerJS': 'https://gw.alipayobjects.com/os/rmsportal/FCyieFdtYznncUQiqbMj.js',//云客服匹配
                        'onlineServerCSS': 'https://gw.alipayobjects.com/os/rmsportal/LweLpHiNhGxWXDpYIXqK.css'//云客服通用样式
                    }
                });
			...
			OS.params.featureStr = "{'tradeNos':'" + tradeNos4Clive + "'}";
			    ...
			    newPortalServerURL: OS.server.cschannelServer + '/newPortal.htm',
                            ...
                            onlineServerIconDefault: 'https://a.alipayobjects.com/u/<%=path%>/resource/all_product/css/201401/1v9cu1dxaf.css' //在线客服默认图片
                        };
            ...
            window.initOnlineServer = function() {
                ...
                s.src = "https://a.alipayobjects.com/??sea<%=path%>/resource/all_product/js/sea<%=path%>/resource/all_product/js/2.1.1/sea.js,jquery/jquery/1.7.2/jquery.js";
...
<div class="server" id="ServerNum">
  excashier-30-5010 &nbsp; 0a6e111f1522333960272419659746_0
</div>
<!-- FD:231:alipay/foot/copyright.vm:2604:foot/copyright.schema:支付宝copyright:END --><!-- FD:231:alipay/foot/copyright.vm:END --></div>
</div><!-- /container -->
<div id=partner><img alt=合作机构 src="<%=path%>/resource/all_product/images/2r3ckfrkqs.png"></div>
...
<script charset="utf-8" src="<%=path%>/resource/all_product/js/index.js"></script>





<!-- FD:231:alipay/tracker/sai.vm:START --><!-- FD:231:alipay/tracker/sai.vm:2890:tracker/sai.schema:sai:START -->
<script>
    sensScanConfig={
        ratio: 0.01,
        modules: '*',
...
<script src='<%=path%>/resource/all_product/js/monitor-sens.min.js'></script>
<!-- FD:231:alipay/tracker/sai.vm:2890:tracker/sai.schema:sai:END --><!-- FD:231:alipay/tracker/sai.vm:END -->
