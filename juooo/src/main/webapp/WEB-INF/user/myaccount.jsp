...
<div class="new-navbar">
    <div class="w1200">
        ...
        <input type="hidden" id="js-login-url" value="http://passport.juooo.com/user/makelogin">   <!--什么东西啊-->
        <input type="hidden" id="js-alipay-url" value="">
    </div>
</div>
<!-- 顶部栏 end  这个外连接没做-->    <!-- top头部 End-->
    <!-- 顶部广告 -->
        ...
        function getLogoAdvert(symbol)
        {
            $.ajax({
                ...
                success:function(result)
                {
                    ...
                    {
                        var advertInfo  = '<div class="logo"><a href="'+result.data.url+'"><img src="picture/dc3c48667b084f7a87a672e5646c688f.gif' + result.data.pic + '" alt="'+ result.data.ad_name + '" title="'+ result.data.ad_name + '"></a></div>';
                    }
                    else
                    {
...
<div class="my-menu">
        ...
        <ul>
            ...
            <li><a class=" active " href="myaccount.html"><i></i><b class="arr"></b>账户余额</a></li>
    ...
    <div class="u-warp2014 mysecurity">
        <div class="u-title clearfix">
            <h3><!-- <i class="myfont">&#xe61b;</i> -->账户余额</h3>
            <div class="o-t-tips">为保障账户和余额安全，建议进行<a href="mysecurity.html">安全设置</a></div>
        </div>
        <div class="g-myjuooo mt20">
            <div class="mt-avatar">
                <dl class="clearfix">
                    ...
                    <dd class="userinfo">
                        <p class="name">hua</p>
                        <!-- <div class="user-lv">等级：普通用户<a target="_blank" href="http://www.juooo.com/help/58">了解会员等级»</a></div> -->
                        <p class="level"><span class="lv-icon" style="background-image: url('<%=path%>/resource/user/images/raoknvmxb0kachvkaaarxyznjhk783.png');"></span></p>
                    </dd>
                </dl>
            </div>
            <div class="mt-integral mt-myaccount mt-balance">
                <span class="desc">账户余额</span>
                <span class="num" style="margin-top:20px;"><i class="yen">¥</i><em class="acc-num">0.00</em></span>
                <div class="mt-btn">
                    <!--  <a class="btn btn-default btn-sm" href="#">立即充值</a>-->
                </div>
            </div>
            <div class="mt-secure">
	<h4>账户安全：</h4>
    ...
    <div class="mo-head">最近账户明细</div>
    <div class="myJuoooMain">
    
<table class="account-table" width="100%" border="0" cellspacing="0" cellpadding="0">
        <colgroup>
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        advertInfo += 'src="picture/dc3c48667b084f7a87a672e5646c688f.gif' + result.data.pic + '" title="' + result.data.ad_name + '" alt="' + result.data.ad_name + '" >';
                        advertInfo += '</a>';
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        html += '<img src="picture/dc3c48667b084f7a87a672e5646c688f.gif' + result.data.pic + '" alt="' + result.data.ad_name + '" title="' + result.data.ad_name + '">';
                        html += '</a>';
