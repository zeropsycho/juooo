                    ...
                    <div class="kind-list js-kind-list js-nav-link">
                       <div class="left-index">
                        ...
                        <div class="right-detail js-right-detail">
                                 ...
                                 style="background-image: url(<%=path%>/resource/user/images/raoknvn7qewahyweaaavxkqyorc553.jpg)">
                                                                                                                                <div class="col">
                                        ...
                                        其他                                        <!--<span>(20)</span>-->
                                                                                                                                            ...
                                                                                                                                            <div class="kind-details pop-details js-kind-details"
                                 style="background-image: url(<%=path%>/resource/user/images/raoknvn7qgcaoj55aaaqu6vnjnw831.jpg)">
                                                                                                                                <div class="col">
                                        ...
                                        其他                                        <!--<span>(20)</span>-->
                                                                                                                                            ...
                                                                                                                                            <div class="kind-details pop-details js-kind-details"
                                 style="background-image: url(<%=path%>/resource/user/images/raoknvn7qhaafro2aaafkohcdbo611.jpg)">
                                                                                                                                <div class="col">
                                        ...
                                        其他                                        <!--<span>(20)</span>-->
                                                                                                                                            ...
                                                                                                                                            <div class="kind-details pop-details js-kind-details"
                                 style="background-image: url(<%=path%>/resource/user/images/raoknvn7qiyaehz1aaavub-rf-u430.jpg)">
                                                                                                                                <div class="col">
                                        ...
                                        其他                                        <!--<span>(20)</span>-->
                                                                                                                                            ...
                                                                                                                                            <div class="kind-details pop-details js-kind-details"
                                 style="background-image: url(<%=path%>/resource/user/images/raokmvn759eap0m-aaas0qyo8la429.jpg)">
                                                                                                                                <div class="col">
                                        ...
                                        音乐剧                                        <!--<span>(20)</span>-->
                                                                                                                                            ...
                                                                                                                                            <div class="kind-details pop-details js-kind-details"
                                 style="background-image: url(<%=path%>/resource/user/images/raoknvn7qm6auwpcaaadmaz5k2s662.jpg)">
                                                                                                                                <div class="col">
                                        ...
                                        其他                                        <!--<span>(20)</span>-->
                                                                                                                                            ...
                                                                                                                                            <div class="kind-details pop-details js-kind-details"
                                 style="background-image: url(<%=path%>/resource/user/images/raoknvn7qoaae51-aaahavn4ayw172.jpg)">
                                                                                                                                <div class="col">
        ...
        function getLogoAdvert(symbol)
        {
            $.ajax({
                ...
                success:function(result)
                {
                    ...
                    {
                        var advertInfo  = '<div class="logo"><a href="'+result.data.url+'"><img src="picture/39c7965db83640059da56f5977493df6.gif' + result.data.pic + '" alt="'+ result.data.ad_name + '" title="'+ result.data.ad_name + '"></a></div>';
                    }
                    else
                    {
...
<div class="myjuooo w1204">
    <div class="my-menu">
        ...
        <ul>
            ...
            <li><a class=" active " href="myaddress.html"><i></i><b class="arr"></b>收货地址</a></li>
        ...
        <div class="u-title clearfix">
            <h3><!-- <i class="myfont">&#xe617;</i> -->收货地址</h3>
        </div>
        <div class="stockPor juo-deliver-address">
            <div class="st-tit">
                <ul class="clearfix">
                    <li class="st-th1">收货人<b class="line"></b></li>
                    <li class="st-th2">地区<b class="line"></b></li>
                    <li class="st-th3">详细地址<b class="line"></b></li>
                    <li class="st-th4">电话/手机<b class="line"></b></li>
                </ul>
            </div>
            <table class="address-table" width="100%" border="0" cellspacing="0" cellpadding="0">
                            </table>
        </div>
        <div class="myaddress-form">
            <div class="EditData-form">
                <div class="edf-tit"><b class="txt">新增收货地址</b></div>
                <form class="form-horizontal" method="post">
                    <input type="hidden" name="address_id" value="">
                    <ul>
                        <li class="clearfix">
                            <span class="e-name"><span class="red">*</span>收货人：</span>
                            <div class="col-md-10">
                                <input class="form-control" name="consignee" type="text" value="" datatype="*1-30" errormsg="<i class='icon-form-warn'></i>不得超过30字" nullmsg="<i class='icon-form-warn'></i>请填写真实姓名！" sucmsg="<i class='icon-form-right'></i>">
                            </div>
                            <div class="Validform_wrap">
                                <span class="Validform_checktip"><i class="ico-warn"></i>请填写真实姓名</span>
                            </div>
                        </li>
                        <li class="clearfix">
                            <span class="e-name"><span class="red">*</span>地区：</span>
                            <div class="col-md-10">
                                <select name="province" nullmsg="<i class='icon-form-warn'></i>地区不完整" sucmsg="<i class='icon-form-right'></i>">
                            ...
                            <div class="Validform_wrap">
                                <span class="Validform_checktip"><i class="ico-warn"></i>送货地址非演出城市</span>
                            </div>
                        </li>
                        <li class="clearfix">
                            <span class="e-name"><span class="red">*</span>详细地址：</span>
                            <div class="col-md-10">
                                <input class="form-control myjc-ipt" name="address" value="" type="text" datatype="*1-100" errormsg="<i class='icon-form-warn'></i>不得超过100字" nullmsg="<i class='icon-form-warn'></i>请填写详细路名及门牌号" sucmsg="<i class='icon-form-right'></i>">
                            </div>
                            <div class="Validform_wrap">
                        ...
                        <li class="clearfix">
                            <span class="e-name">邮政编码：</span>
                            <div class="col-md-10" id="zipDiv">
                                <input class="form-control" name="zipcode" value="" type="text" ignore="ignore" datatype="p" errormsg="<i class='icon-form-warn'></i>请填写有效的邮政编码（可不填）" sucmsg="<i class='icon-form-right'></i>">
                            </div>
                            <div class="Validform_wrap">
                                <span class="Validform_checktip"><i class="ico-warn"></i></span>
                            </div>
                        </li>
                        <li class="clearfix">
                            <span class="e-name"><span class="red">*</span>手机号码：</span>
                            <div class="col-md-10">
                                <input class="form-control" name="mobile" value="" type="text" datatype="m" nullmsg="<i class='icon-form-warn'></i>手机号不能为空！" errormsg="<i class='icon-form-warn'></i>请填写真实的手机号，以便客服及时与您联系及送货前确认" sucmsg="<i class='icon-form-right'></i>">
                            </div>
                            <div class="Validform_wrap">
                                <span class="Validform_checktip"><i class="ico-warn"></i></span>
                            </div>
                        ...
                        <li class="clearfix">
                            <span class="e-name">固定电话：</span>
                            <div class="col-md-10">
                                <input class="form-control" name="tel" type="text" ignore="ignore" value="" datatype="/^$/|/^\d{3}-\d{8}$/i|/^\d{4}-\d{7}$/i" errormsg="<i class='icon-form-warn'></i>请输入正确的电话号码，eg. 010-76654834（可不填）" sucmsg="<i class='icon-form-right'></i>">
                            </div>
                            <div class="Validform_wrap">
                                <span class="Validform_checktip"><i class="ico-warn"></i></span>
                            </div>
                        ...
                        <li class="clearfix">
                            <span class="e-name"><span class="red"></span>电子邮箱：</span>
                            <div class="col-md-10">
                                <input class="form-control" name="email" value="" type="text" ignore="ignore" datatype="e" errormsg="<i class='icon-form-warn'></i>请填写正确的电子邮箱，用来接收订单提醒，及时了解订单状态" nullmsg="<i class='icon-form-warn'></i>邮箱不能为空！" sucmsg="<i class='icon-form-right'></i>">
                            </div>
                            <div class="Validform_wrap">
                                <span class="Validform_checktip"><i class="ico-warn"></i></span>
                            </div>
                        ...
                        <li class="clearfix">
                            ...
                            <label class="label-cursor"><span class="s-checkbox " id="checkstate"></span>设为默认收货地址</label>
                        </li>
                        <li class="clearfix" style="padding:0;">
                            <span class="e-name">&nbsp;</span>
                            <button class="btn no-unl bg-fe5d36" id="save">
                                确认
                                                            </button>
                        </li>
                    </ul>
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        advertInfo += 'src="picture/39c7965db83640059da56f5977493df6.gif' + result.data.pic + '" title="' + result.data.ad_name + '" alt="' + result.data.ad_name + '" >';
                        advertInfo += '</a>';
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        html += '<img src="picture/39c7965db83640059da56f5977493df6.gif' + result.data.pic + '" alt="' + result.data.ad_name + '" title="' + result.data.ad_name + '">';
                        html += '</a>';
...
seajs.use(['Dialog','juo','index'], function(Dialog) {
    $(function(){
        var aid;
        $('.del-addr').on('click',function(){
            aid = $(this).closest('td').attr('address-id');
            Dialog.confirm({
                content: '确定要删除该地址吗',
                width: 220,
                okBtnCallback: function(index){
                    window.location.href = "http://myjuooo.juooo.com/User/deladdress/aid/" + aid;
                    Dialog.close(index);
                }
            })
        })
...
$(".form-horizontal").Validform({
    ...
    beforeSubmit: function() {
        ...
        if (province > 0 && city > 0 && district > 0) {
            $("select[name='district']").closest('li').find('.Validform_checktip').removeClass('Validform_wrong').html('<i class="icon-form-right"></i>');
            return true
        } else {
            $("select[name='district']").closest('li').find('.Validform_checktip').addClass('Validform_wrong').html('<i class="icon-form-warn"></i>地区不完整');
            return false
        }
    }
});
