        ...
        function getLogoAdvert(symbol)
        {
            $.ajax({
                ...
                success:function(result)
                {
                    ...
                    {
                        var advertInfo  = '<div class="logo"><a href="'+result.data.url+'"><img src="picture/a38362e274354727ab662328f6af5585.gif' + result.data.pic + '" alt="'+ result.data.ad_name + '" title="'+ result.data.ad_name + '"></a></div>';
                    }
                    else
                    {
...
<div class="my-menu">
        ...
        <ul>
            <li><a class=" active " href="mycomment.html"><i></i><b class="arr"></b>我的剧评</a></li>
        </ul>
    ...
    <div class="u-warp2014">
      <div class="u-title">
          <h3>我的剧评</h3>
            <div class="o-t-tips">写剧评，赚聚橙积分，兑换演出票，现在写剧评还送1积分！<a target="_blank" href="http://www.juooo.com/help/56">了解积分兑换»</a></div>
        </div>
        
        <div class="mycomment">
            <div class="si-tabs clearfix">
                <span class="note-sit-a" style="float:right">共0条剧评</span>
                <ul class="si-tabUl">
                    <li class="active">我的剧评</li>
                </ul>
            </div>
  
    		<div class="comm-list">
    		        		 <div class="item clearfix" style="text-align:center">无记录</div>
        		      		</div>  
    		<div class="pages"></div>
        </div>       
    </div> 
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        advertInfo += 'src="picture/a38362e274354727ab662328f6af5585.gif' + result.data.pic + '" title="' + result.data.ad_name + '" alt="' + result.data.ad_name + '" >';
                        advertInfo += '</a>';
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        html += '<img src="picture/a38362e274354727ab662328f6af5585.gif' + result.data.pic + '" alt="' + result.data.ad_name + '" title="' + result.data.ad_name + '">';
                        html += '</a>';
