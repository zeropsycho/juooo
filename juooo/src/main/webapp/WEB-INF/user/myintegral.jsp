        ...
        function getLogoAdvert(symbol)
        {
            $.ajax({
                ...
                success:function(result)
                {
                    ...
                    {
                        var advertInfo  = '<div class="logo"><a href="'+result.data.url+'"><img src="picture/935b5d605cfa47c7b70bb533af928398.gif' + result.data.pic + '" alt="'+ result.data.ad_name + '" title="'+ result.data.ad_name + '"></a></div>';
                    }
                    else
                    {
...
<div class="my-menu">
        ...
        <ul>
            ...
            <li><a class=" active " href="myintegral.html"><i></i><b class="arr"></b>我的积分</a></li>
        </ul>
      ...
      <div class="u-title">
          <h3>我的积分</h3>
            <div class="o-t-tips">积分是网站反馈给用户的虚拟货币，积分采用逾期自动清零的方式，请注意积分到期时间！<a target="_blank" href="http://www.juooo.com/help/56">了解积分兑换»</a></div>
        </div>
        
        <div class="m-integral mt20">
          <div class="mit-head">
          <div class="mith-num">
            会员积分： <em class="num">24</em>分
            <a href="..\run\scores.html" target="_blank">积分换购»</a>
          </div>
              <div class="mith-menu">
   <a href="/user/myintegral?type=0"   class="on" >积分获取</a>
   <a href="/user/myintegral?type=1" >积分使用</a>

                <b class="line"></b>
                </div>
                <a target="_blank" href="http://www.juooo.com/help/56" class="way-obtain">如何获取积分?</a>
            </div>
          <div class="mit-bd mt20">
              <div>
<table class="mith-table" width="100%" border="0" cellspacing="0" cellpadding="0">
<colgroup>
  ...
  <tbody>
                <tr>
        <td>每日登录</td>
        <td><span class="plus">+2</span> </td>
        <td>2018.03.23</td>
      </tr>
            <tr>
        <td>新用户手机注册</td>
        <td><span class="plus">+20</span> </td>
        <td>2018.03.22</td>
      </tr>
            <tr>
        <td>每日登录</td>
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        advertInfo += 'src="picture/935b5d605cfa47c7b70bb533af928398.gif' + result.data.pic + '" title="' + result.data.ad_name + '" alt="' + result.data.ad_name + '" >';
                        advertInfo += '</a>';
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        html += '<img src="picture/935b5d605cfa47c7b70bb533af928398.gif' + result.data.pic + '" alt="' + result.data.ad_name + '" title="' + result.data.ad_name + '">';
                        html += '</a>';
