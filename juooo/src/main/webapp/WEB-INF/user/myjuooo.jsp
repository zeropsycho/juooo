        ...
        function getLogoAdvert(symbol)
        {
            $.ajax({
                ...
                success:function(result)
                {
                    ...
                    {
                        var advertInfo  = '<div class="logo"><a href="'+result.data.url+'"><img src="picture/d8a7b3e34e9c44a182c8e70381c461a7.gif' + result.data.pic + '" alt="'+ result.data.ad_name + '" title="'+ result.data.ad_name + '"></a></div>';
                    }
                    else
                    {
...
<div class="myjuooo w1204">
        ...
        <div class="g-myjuooo">
            <div class="mt-avatar">
                <dl class="clearfix">
                    ...
                    <dd class="userinfo">
                        <p class="name">hua</p>
                        <!-- <div class="user-lv">等级：普通用户</div>
                        <p class="more-lv"><a href="http://www.juooo.com/help/58">了解会员等级»</a></p>
                        -->
                        <p class="level">
                        	<a href="#">
                        		<span class="lv-icon" style="background-image: url('<%=path%>/resource/user/images/raoknvmxb0kachvkaaarxyznjhk783.png');"></span>
                        	</a>
                        </p>
                    </dd>
                </dl>
                <div class="mt-edit-security"><a href="http://myjuooo.juooo.com/User/changepass">修改密码</a>&#12288;|&#12288;<a href="myprofile.html">修改基本信息</a></div>
            </div>
            
            <div class="mt-integral">
                <div class="h4_tit">会员积分</div>
                <div class="num"><strong class="f-num js-scores"></strong> 分</div>
                <div class="mt-btn"><a class="btn btn-simple" href="..\run\scores.html">兑换礼品</a></div>
            </div>
            <div class="mt-integral mt-balance">
                <div class="h4_tit">账户余额</div>
                <div class="num" style="margin-top:20px;"><i class="yen f-16px">¥</i><strong class="f-num js-money"></strong></div>
                <!--  <div class="mt-btn"><a class="btn btn-default btn-sm" href="javascript:;">立即充值</a></div>-->
            </div>
            <div class="mt-secure">
	<h4>账户安全：</h4>
	...
	<div class="secure-binding">
        ...
        <div class="mt20 clearfix">
            <div class="mth-order">
                <div class="mth-tit"><b></b>我的订单<span class="mth-order-tit"><a href="myorderlist.html/status/1/">待支付</a><em class="line">|</em><a href="myorderlist.html/status/2/">待收货</a><em class="line">|</em><a href="myorderlist.html/status/3/">待评价 </a></span></div>
                <div class="com-loading hide">
					<img src="picture/loading-juo.gif" alt="">
					<p>数据加载中，请稍后...</p>
				</div>
                <div class="mth-order-bd">
						<table class="mth-order-table" width="100%" border="0"
							...
							<div class="no-mth-order hide">
								<p class="myfont">&#xe607;</p>
								<p>您还没有票品订单！</p>
								<p>
									<a href="http://search.juooo.com/">选购票品»</a>
								</p>
							</div>
						</table>
					</div>
            ...
            <div class="mth-comment">
                <div class="mth-tit"><b></b>我的关注</div>
                <div class="com-loading hide">
					<img src="picture/loading-juo.gif" alt="">
					<p>数据加载中，请稍后...</p>
				</div>
                <div class="mth-buy-bd">
                <div class="no-mth-order hide">
                    <p class="myfont">&#xe610;</p>
                    <p>您尚未关注演出！</p>
                    <p><a href="http://search.juooo.com/">查看最新演出»</a></p>
                </div>
                    <ul>
            ...
            <div class="mth-note">
                <div class="mth-tit"><b></b>我的提醒</div>
                <div class="com-loading hide">
					<img src="picture/loading-juo.gif" alt="">
					<p>数据加载中，请稍后...</p>
				</div>
            ...
            <div class="mth-news">
                <div class="mth-tit"><b></b>我的消息</div>
				<div class="com-loading hide">
					<img src="picture/loading-juo.gif" alt="">
					<p>数据加载中，请稍后...</p>
				</div>
        ...
        <div class="mt-recommend clearfix">
            <h3 class="tit"><b></b>推荐演出</h3>
            <div class="com-loading hide">
				<img src="picture/loading-juo.gif" alt="">
				<p>数据加载中，请稍后...</p>
			</div>
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        advertInfo += 'src="picture/d8a7b3e34e9c44a182c8e70381c461a7.gif' + result.data.pic + '" title="' + result.data.ad_name + '" alt="' + result.data.ad_name + '" >';
                        advertInfo += '</a>';
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        html += '<img src="picture/d8a7b3e34e9c44a182c8e70381c461a7.gif' + result.data.pic + '" alt="' + result.data.ad_name + '" title="' + result.data.ad_name + '">';
                        html += '</a>';
...
seajs.use(['Dialog','juo','index'], function(Dialog) {
    $(function(){
        ...
        $(document).on('click','.del-order', function(){
            ...
            Dialog.confirm({
                title: '提示',
                content: "<div class=\"cal-confirm\" style=\"text-align:center\"><i class=\"icon-ques\"></i><span style=\"display:inline-block;padding:10px 10px 0 0;\">确认要删除此订单吗？</span></div>",
                width: 450,
                okBtnCallback: function(index){
                    updateOrderStatus(0, order_sn);
                    Dialog.close(index);
                }
            });
        });
	...
	var noteUrl 	 = "http://myjuooo.juooo.com/User/noteinfo/note/" ;
	var orderInfoUrl = "http://myjuooo.juooo.com/User/myorderinfo/orderSn/";
	var doorUrl		 = "http://myjuooo.juooo.com/User/opendoor";
	var aroundUrl	 = "http://around.juooo.com/";
	
	getUserBasicAndSec();
	getOrderStatusList(0);
	autoLoadOrderList();
	autoLoadNoteList();
	autoLoadCommentList();
	autoLoadRemindList();
    ...
    $(function() {
        ...
        $(document).on('click', '.order-cancel', function() {
            cancel_order_sn = $(this).attr('data-sn');

            // 给弹框传index
            var index = +new Date();
            $(this).parents('.mo-item').attr('index', index);
            var content = "<div class=\"cal-content\" index=\"" + index + "\"><ul class=\"clearfix\"><li><label><input name=\"clearcon\" type=\"radio\" value=\"订单重复\">订单重复</label></li><li><label><input name=\"clearcon\" type=\"radio\" value=\"更换其他票品\">更换其他票品</label></li><li><label><input name=\"clearcon\" type=\"radio\" value=\"订购错误\">订购错误</label></li><li><label><input name=\"clearcon\" type=\"radio\" value=\"支付失败\">支付失败</label></li><li><label><input name=\"clearcon\" type=\"radio\" value=\"已在别处购买\">已在别处购买</label></li><li><label><input name=\"clearcon\" type=\"radio\" value=\"票价太贵\">票价太贵</label></li><li><label><input name=\"clearcon\" type=\"radio\" value=\"测试订单\">测试订单</label></li><li><label><input name=\"clearcon\" type=\"radio\" value=\"其他\">其他</label></li></ul></div><span class=\"calorder-msg\" style=\"height:10px\">请选择订单取消的原因</span>";
            dialog_index = Dialog.confirm({
                width: 500,
                content: content,
                title: '请选择订单取消的原因',
                okBtnCallback: function(num) {
                    var index0 = $('.cal-content').attr('index');
                    // 选中选项
                    if ($('.cal-content input[type="radio"]:checked').length == 1) {
                        var clearCon = $('.cal-content input[type="radio"]:checked').val();
                        cancelOrderStatus(cancel_order_sn, clearCon);
                        Dialog.close(num);
                    } else {
                        $('.calorder-msg').css('display','block');
                    }
                }
            });
        });
