        ...
        function getLogoAdvert(symbol)
        {
            $.ajax({
                ...
                success:function(result)
                {
                    ...
                    {
                        var advertInfo  = '<div class="logo"><a href="'+result.data.url+'"><img src="picture/eea603d1695441ce839816e886603100.gif' + result.data.pic + '" alt="'+ result.data.ad_name + '" title="'+ result.data.ad_name + '"></a></div>';
                    }
                    else
                    {
...
<div class="my-menu">
    ...
    <div class="u-warp2014 mysecurity">
        ...
        <div class="note">
            ...
            <div class="si-tab-bd">
                <div class="note-main">
                        <ul class="nt-thead clearfix">
                            <li class="nt-td1">发件人</li>
                            <li class="nt-td2">主题</li>
                            <li class="nt-td3">时间</li>
                        </ul>
                        <div class="nt-tableBox">
<table width="100%" class="note-table" border="0" cellspacing="0" cellpadding="0">
<colgroup>
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        advertInfo += 'src="picture/eea603d1695441ce839816e886603100.gif' + result.data.pic + '" title="' + result.data.ad_name + '" alt="' + result.data.ad_name + '" >';
                        advertInfo += '</a>';
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        html += '<img src="picture/eea603d1695441ce839816e886603100.gif' + result.data.pic + '" alt="' + result.data.ad_name + '" title="' + result.data.ad_name + '">';
                        html += '</a>';
