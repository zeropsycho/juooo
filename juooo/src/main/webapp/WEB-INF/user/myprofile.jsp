        ...
        function getLogoAdvert(symbol)
        {
            $.ajax({
                ...
                success:function(result)
                {
                    ...
                    {
                        var advertInfo  = '<div class="logo"><a href="'+result.data.url+'"><img src="picture/8c1b30ff4a214efe93cca44a896d8ae4.gif' + result.data.pic + '" alt="'+ result.data.ad_name + '" title="'+ result.data.ad_name + '"></a></div>';
                    }
                    else
                    {
...
<div class="my-menu">
        ...
        <ul>
            <li><a class=" active " href="myprofile.html"><i></i><b class="arr"></b>个人资料</a></li>
    ...
    <div class="u-warp2014">
        <div class="u-title clearfix">
            <h3><!-- <i class="myfont">&#xe61d;</i> -->个人资料</h3>
            <div class="o-t-tips">为了能为您提供个性化服务，完善资料中的真实姓名、性别、出生日期、演出喜好等信息，可获50积分！<a target="_blank" href="http://www.juooo.com/help/56">了解积分兑换»</a></div>
        </div>
        <div class="note">
            <div class="si-tabs clearfix">
                <div class="mod-progress profile-inner">
                <span class="secure-lv-txt" style="color: #999;  float: left; font-size: 13px; padding-right:10px; margin-top: 3px;">资料完整度</span>
                    <div class="inner">
                        <div class="rate" style="width:20%;"></div>
                    </div>
                    <span class="secure-lv-txt">20%</span>
                </div>
                <ul class="si-tabUl">
                    <li class="active"><a href="javascript:;" data-target="tab-box-01">编辑资料</a></li>
                    <li class=""><a href="javascript:;" data-target="tab-box-02">头像设置</a></li>
                    <div class="line"></div>
                </ul>
            </div>
            <div class="si-tab-bd">
<div class="myprofile">
<!--上传头像-->
<div class="upload-avatar " id="tab-box-02">
    <div class="wrap" id="jcropdiv" style="display: block;">
        <label for="upload-file" class="btn btn-default">本地上传
                <input type="file" name="files[]" id="upload-file" value="本地上传">
        </label>
        <p>仅支持JPG、GIF、PNG、BMP图片，大小不限</p>
        <div class="wl">
            <div class="jc-demo-box" data="0">
                <div id="target" class="jcrop-w">
                <img src="" id="preview" alt="" title="请上传图片">
                <span class="jcrop-tip">请上传头像</span>
                </div>
            </div>
            <div class="jy-up-ch">
                <a id="idLeft" href="javascript:;" class="bch bch1"> </a>
                <a id="idSmall" href="javascript:;" class="bch bch2"> </a>
                <a id="idBig" href="javascript:;" class="bch bch3"> </a>
                <a id="idRight" href="javascript:;" class="bch bch4"> </a>
            </div>
        </div>
        <div class="wr" id="preview-pane">
            <div class="preview-container">
                <div class="pre-1">
                    <img src="" class="jcrop-preview jcrop-preview-s" alt="" />
                </div>
                <p class="desc-1">120*120像素</p>
                <div class="pre-2">
                    <img src="" class="jcrop-preview jcrop-preview-s" alt="" />
                </div>
                <p class="desc-2">48*48像素</p>
                <div class="pre-3">
                    <img src="" class="jcrop-preview jcrop-preview-s" alt="" />
                </div>
                <p class="desc-3">20*20像素</p>
            </div>
        </div>
        <div class="operation">
            <input type="button" class="btn btn-default bg-fe5d36" id="save-btn" value="保存">
            <input type="button" class="btn btn-default" id="cal-bth"  onclick= "location.href=''" value="取消">
        </div>
                <input type="hidden" id="x" value="0">
                <input type="hidden" id="y" value="0">
                <input type="hidden" id="w" value="300">
                <input type="hidden" id="h" value="300">
                <input type="hidden" id="scale" value="0">
                <input type="hidden" id="direction" value="0">
    </div>
</div>
<!--上传头像end-->
<!--编辑资料-->
<div class="EditData active" id="tab-box-01">
    <div class="ed-tipt">为了您的帐户安全，请验证邮箱和验证手机 ，现在验证赠送积分！</div>
        <div class="EditData-form">
        <div class="edf-tit"><b class="txt">基本资料:</b></div>
        <form class="form-horizontal registerform" method="post">
        <ul>
            <li class="clearfix">
                <span class="e-name">昵称：</span>
                <div class="col-md-10">
                <input class="form-control" name="nick_name" type="text" datatype="*1-30" value="hua" nullmsg="<i class='icon-form-warn'></i>昵称不能为空！" sucmsg="<i class='icon-form-right'></i>" maxlength="30">
                <input type="hidden" id="checknn">
                </div>
            </li>
            <li class="clearfix">
                <span class="e-name">登录邮箱：</span>
                <div class="col-md-10">
                <input type="hidden" name="checkemail" value="0">
                                <input type="text" class="form-control" style="padding-left:85px" name="email" ignore="ignore" value="尚未绑定邮箱" disabled>
                                <div class="e-verify">
                <a href="javascript:gosecu(1);">去绑定</a>                </div>
                </div>
            </li>
            <li class="clearfix">
                <span class="e-name">绑定手机：</span>
                <div class="col-md-10">
                <input type="hidden" name="checkmobile" value="1">
                
                                <input type="text" class="form-control" style="padding-left:85px;background:#e3e3e3" name="mobile" ignore="ignore" value="15927367171" disabled>
                                <div class="e-verify">
                已绑定                </div>
                </div>
            </li>
            <li class="clearfix">
                ...
                <div class="col-md-10">
                <input class="form-control" name="name" type="text" ignore="ignore"  value=""  disabled=""   style="padding-left:85px;background:#e3e3e3">
                </div>
            </li>
                ...
                <div class="col-md-10">
                <input class="form-control" name="name" type="text" ignore="ignore"  disabled=""  value=""   style="padding-left:85px;background:#e3e3e3">
                </div>
            </li>
            ...
            <li class="clearfix">
                ...
                <div class="col-md-10">
                <textarea class="form-control form-textarea" rows="3" name="address" ignore="ignore" datatype="*1-100" sucmsg=" "></textarea>
                </div>
            </li>
        </ul>
        <div class="edf-tit"><b class="txt">其他资料:</b></div>
        <ul>
            <li class="clearfix">
                <span class="e-name">出生日期：</span>
                <div class="col-md-10">
                <input type="text" name="birthday" class="form-control icon-laydate" onclick="laydate()" ignore="ignore" value="" style="font-size:14px" readonly> 
                </div>
            </li>
            <li class="clearfix">
                ...
                <select name="marriage">
                   <option selected="selected" value="0">--请选择--</option>
                                      <option value="1" >已婚暂无子女</option>
                                      <option value="2" >已婚且有子女</option>
            ...
            <li class="clearfix">
                ...
                <select name="income">
                   <option selected="selected" value="0">--请选择--</option>
                                      ...
                                      <option value="3" >2000-3999元</option>
                                      <option value="4" >4000-5999元</option>
                                      <option value="5" >6000-7999元</option>
                                      <option value="6" >8000-9999元</option>
            ...
            <li class="form-group clearfix">
                ...
                <div class="col-md-10">
                <textarea class="form-control form-textarea" rows="3" name="remark" ignore="ignore"></textarea>
                </div>
            </li>
            <li class="clearfix">
                <span class="e-name">&nbsp;</span>
                <button type="submit" class="save-profile btn-default btn no-unl bg-fe5d36">保存资料</button>
                <!--  <button class="btn btn-default" id="submit">保存资料</button>-->
            </li>
        </ul>
        </form>
        
        <form action="http://myjuooo.juooo.com/User/secumail" method="post" id="secumail_form">
        <input type="hidden" name="secumail">
        </form>
        
        <form action="http://myjuooo.juooo.com/User/secuphone" method="post" id="secuphone_form">
        <input type="hidden" name="secuphone">
        </form>
    </div>
</div>
<!--编辑资料end-->
...
<link rel="stylesheet" href="<%=path%>/resource/user/css/laydate.css">
<script type="text/javascript" src="<%=path%>/resource/user/js/jquery.min.js"></script>
<script type="text/javascript">
	var basicDomainUrl="//basic.juooo.com/";
</script>
<script type="text/javascript" src="<%=path%>/resource/user/js/laydate.js"></script>
<script type="text/javascript" src="<%=path%>/resource/user/js/validform_v5.3.2.js"></script>
<!-- <script type="text/javascript" src="<%=path%>/resource/user/js/myjuooo.js"></script> -->
<script type="text/javascript" src="<%=path%>/resource/user/js/common.js"></script>
<script src="<%=path%>/resource/user/js/jquery.jcrop.js"></script>
<script src="<%=path%>/resource/user/js/crop-img.js"></script>

<script src="<%=path%>/resource/user/js/jquery.ui.core.js"></script>
<script src="<%=path%>/resource/user/js/jquery.ui.widget.js"></script>
<script src='<%=path%>/resource/user/js/jquery.fileupload.js'></script>
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        advertInfo += 'src="picture/8c1b30ff4a214efe93cca44a896d8ae4.gif' + result.data.pic + '" title="' + result.data.ad_name + '" alt="' + result.data.ad_name + '" >';
                        advertInfo += '</a>';
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        html += '<img src="picture/8c1b30ff4a214efe93cca44a896d8ae4.gif' + result.data.pic + '" alt="' + result.data.ad_name + '" title="' + result.data.ad_name + '">';
                        html += '</a>';
...
$(function(){
	var uploading = 0;//上传中标记
	$('#upload-file').fileupload({
        url:'http://myjuooo.juooo.com/User/uploadhead',
        type:'POST',
        maxNumberOfFiles : 1,
        dataType: 'json',
        autoUpload: true,
        ...
        add: function (e, data) {
            ...
            $("#save-btn").click(function(){
                ...
                data.formData = {x:x,y:y,w:w,h:h,scale:scale,direction:direction}
                data.submit();
                uploading = 1;
            })
        },
            ...
            if(data.result.status==1){
                Dialog.alert({
                    ...
                    okBtnCallback: function(){
                        window.location.href = 'myprofile.html/profile/2';
                    }
                });
            }else{
                uploading = 0;
    ...
    $(".registerform").Validform({
        ...
        beforeSubmit:function(){
            var checknn=$("#checknn").val();
            if(checknn==1){
            	$("input[name='nick_name']").siblings('.Validform_checktip').removeClass('Validform_right').addClass('Validform_wrong').html("<i class='icon-form-warn'></i>该昵称已被占用！");
...
seajs.use(['Dialog','juo','index'], function(Dialog) {
    
$("#preview").attr('style', 'left:0px;top:0px;');
	
    $('.si-tabUl li').on('click',function(){
        var data_target = $(this).find('a').attr('data-target');
        $(this).addClass('active').siblings('li').removeClass('active');
        $('#'+data_target).addClass('active');
        $('#'+data_target).siblings().removeClass('active');
    });
    ...
    $("#idRight").click(function(){
    	var direction=$("#direction").val();
    	direction--;
    	$("#direction").val(direction);
    })
    
    var pList=getRegion(1,1);
	var p_id="0";
	var c_id="0";
	var d_id="0";
	$("select[name='province']").empty();
    $("select[name='province']").append(pList);
	if(p_id){
		$("select[name='province']").val(p_id);
		var cList=getRegion(p_id,2);
		$("select[name='city']").empty();
        $("select[name='city']").append(cList);
        if(c_id){
        	$("select[name='city']").val(c_id);
        	var dList=getRegion(c_id,3);
        	$("select[name='district']").empty();
            $("select[name='district']").append(dList);
            $("select[name='district']").val(d_id);
        }
	}
	
    //填写昵称验证是否被占用
    $("input[name='nick_name']").change(function(){
        ...
        if (nickname){
            $.ajax({
                type : 'POST',
                url : 'http://myjuooo.juooo.com/User/checknickname',
    ...
    $("select[name='province']").change(function(){
        ...
        $("select[name='district']").empty();
        $("select[name='district']").append("<option value='0'>--请选择--</option>");
    });
...
//手机、邮箱验证 1邮箱 2手机
function gosecu(type){
    if(type==1){
        //var email = $("input[name='email']").val();
        //if(email){
        //  $("input[name='secumail']").val(email)
        //}
        $("#secumail_form").submit();
    }
    if(type==2){
        //var mobile = $("input[name='mobile']").val();
        //if(mobile){
        //  $("input[name='secuphone']").val(mobile)
        //}
        $("#secuphone_form").submit();
    }
}
