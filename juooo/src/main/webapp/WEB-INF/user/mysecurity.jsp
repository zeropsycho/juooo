                    ...
                    <!-- 侧边导航 -->
							<div class="kind-list js-kind-list js-nav-link">
								<div class="left-index">
									<a href="../All_product/vocalConcert.html" class="kind-link js-kind-link" target="_blank">
										<i class="bg-icon kind-icon pop" style="background-image: url(<%=path%>/resource/user/images/raokmvn7qduaspnaaaaeto5fqlu795_2.png);"></i>
									...
									<a href="../All_product/music.html" class="kind-link js-kind-link" target="_blank">
										<i class="bg-icon kind-icon pop" style="background-image: url(<%=path%>/resource/user/images/raokmvn7qfeacmibaaaefux5vuu038_2.png);"></i>
										<span class="kind-text">音乐会</span>
										<i class="bg-icon more-icon"></i>
									</a>
									<a href="../All_product/drama.html" class="kind-link js-kind-link" target="_blank">
										<i class="bg-icon kind-icon pop" style="background-image: url(<%=path%>/resource/user/images/raokmvn7qg6aac9iaaaedcanr-c618_2.png);"></i>
										<span class="kind-text">话剧歌剧</span>
										<i class="bg-icon more-icon"></i>
									</a>
									<a href="../All_product/child.html" class="kind-link js-kind-link" target="_blank">
										<i class="bg-icon kind-icon pop" style="background-image: url(<%=path%>/resource/user/images/raokmvn7qiaafuhtaaag30h30mi241_2.png);"></i>
										<span class="kind-text">儿童亲子</span>
										<i class="bg-icon more-icon"></i>
									</a>
									<a href="../All_product/musical.html" class="kind-link js-kind-link" target="_blank">
										<i class="bg-icon kind-icon pop" style="background-image: url(<%=path%>/resource/user/images/raokmvn7qj2ahhqhaaagybomok8111_2.png);"></i>
										<span class="kind-text">音乐剧</span>
										<i class="bg-icon more-icon"></i>
									</a>
									<a href="../All_product/variety.html" class="kind-link js-kind-link" target="_blank">
										<i class="bg-icon kind-icon pop" style="background-image: url(<%=path%>/resource/user/images/raokmvn7qmkabw9saaagsgbqhxe942_2.png);"></i>
										<span class="kind-text">戏曲综艺</span>
										<i class="bg-icon more-icon"></i>
									</a>
									<a href="../All_product/exhibition.html" class="kind-link js-kind-link" target="_blank">
										<i class="bg-icon kind-icon pop" style="background-image: url(<%=path%>/resource/user/images/raokmvn7qn2aeg2uaaaeesj_ld4456_2.png);"></i>
								...
								<div class="right-detail js-right-detail">
									<div class="kind-details pop-details js-kind-details" style="background-image: url(<%=path%>/resource/user/images/raoknvn7qewahyweaaavxkqyorc553_1.jpg)">
										<div class="col">
									...
									<div class="kind-details pop-details js-kind-details" style="background-image: url(<%=path%>/resource/user/images/raoknvn7qgcaoj55aaaqu6vnjnw831_2.jpg)">
										<div class="col">
									...
									<div class="kind-details pop-details js-kind-details" style="background-image: url(<%=path%>/resource/user/images/raoknvn7qhaafro2aaafkohcdbo611_2.jpg)">
										<div class="col">
									...
									<div class="kind-details pop-details js-kind-details" style="background-image: url(<%=path%>/resource/user/images/raoknvn7qiyaehz1aaavub-rf-u430_2.jpg)">
										<div class="col">
									...
									<div class="kind-details pop-details js-kind-details" style="background-image: url(<%=path%>/resource/user/images/raokmvn759eap0m-aaas0qyo8la429_2.jpg)">
										<div class="col">
									...
									<div class="kind-details pop-details js-kind-details" style="background-image: url(<%=path%>/resource/user/images/raoknvn7qm6auwpcaaadmaz5k2s662_2.jpg)">
										<div class="col">
									...
									<div class="kind-details pop-details js-kind-details" style="background-image: url(<%=path%>/resource/user/images/raoknvn7qoaae51-aaahavn4ayw172_2.jpg)">
										<div class="col">
						...
						<li class="nav-item entry-li">
							<a href="" class="nav-link entry" target="_blank" title="">
								<img src="<%=path%>/resource/user/images/raoknvpb_02auf1faajhopvn-jm883_2.gif" alt="" class="entry-img">
							</a>
						</li>
						<!-- 右侧年卡入口 end -->
            </ul>
        ...
        function getLogoAdvert(symbol)
        {
            $.ajax({
                ...
                success:function(result)
                {
                    ...
                    {
                        var advertInfo  = '<div class="logo"><a href="'+result.data.url+'"><img src="picture/73b9285a37f44b5c950092125787c07a.gif' + result.data.pic + '" alt="'+ result.data.ad_name + '" title="'+ result.data.ad_name + '"></a></div>';
                    }
                    else
                    {
...
<div class="myjuooo w1204">
	<div class="my-menu">
        ...
        <ul>
            ...
            <li><a class=" active " href="mysecurity.html"><i></i><b class="arr"></b>账户安全</a></li>
	...
	<div class="u-warp2014 mysecurity">
		<div class="u-title clearfix">
			<h3>
				<!-- <i class="myfont">&#xe614;</i> -->账户安全
			</h3>
		</div>
		<div class="g-myjuooo mt20">
			<div class="mt-avatar">
				<dl class="clearfix">
					<dt>
						<a href="myprofile.html"><img src="picture/logo.jpg"><p class="up">上传头像</p></a>					</dt>
					<dd class="userinfo">
						<p class="name">
							hua						</p>
						<div class="user-lv">
							等级：
							普通用户							<a target="_blank" href="http://www.juooo.com/help/58">了解会员等级»</a>
						</div>
					</dd>
				</dl>
			</div>
			<div class="mt-integral mt-changePassword">
				<a href="http://myjuooo.juooo.com/User/changepass"> <i class="myfont">&#xe605;</i>
					<p>[修改密码]</p>
				</a>
			</div>
			<div class="mt-integral mt-information">
				<a href="myprofile.html"> <i class="myfont">&#xe609;</i>
					<p>[修改基本信息]</p>
				</a>
			</div>
			<div class="mt-secure">
	...
	<div class="mod_progress">
		...
		<span class="secure-lv-txt js-sec"></span>
	</div>
	<div class="secure-tip">
		为保障账户和余额安全，建议进行 <a href="mysecurity.html">安全设置</a>
	</div>
	<div class="secure-binding">
		<ul>
			<li><b class="myfont s-mobile">&#xe60a;</b>手机： <span class=""></span></li>
			<li><b class="myfont s-mail">&#xe60d;</b>邮箱： <span class=""></span></li>
			<li><b class="myfont s-pay-pass">&#xe614;</b>支付密码： <span class=""></span></li>
		</ul>
	</div>
</div>		</div>
		<div class="m-Security mt20">
			<div class="mo-head">您的安全服务</div>
			<div class="securityMain">
				<div class="accounts-con">
					<ul>
						<li class="bt0"><i class="myfont iconS-ok">&#xe620;</i>
							<div class="acc-name">密 码：</div>
							<div class="acc-txt">
								当前密码安全度：<b class="secure-lv-txt" style="color: #f85709;">
									低								</b>
								<p>为了保证您的帐户和余额的安全，请定期修改您的密码</p>
							</div>
							<div class="acc-btn">
								<a class="btn btn-simple btn-sm"
									href="http://myjuooo.juooo.com/User/changepass">修改密码</a>
							</div></li>
												<li><i class="jufont iconS-warn">&#xe626;</i>
							<div class="acc-name">邮箱验证：</div>
							<div class="acc-txt">
								尚未验证邮箱
								<p>验证邮箱，可帮助您找回密码，接收订单、演出通知、活动等提醒</p>
							</div>
							<div class="acc-btn">
								<a class="btn btn-simple btn-sm" href="/user/secumail">立即验证</a>
							</div></li>
																		<li><i class="myfont iconS-ok">&#xe620;</i>
							<div class="acc-name">手机验证：</div>
							<div class="acc-txt mt10">
								已验证
								<p></p>
							</div>
							<div class="acc-btn"></div></li>
																		<li><i class="jufont iconS-warn">&#xe626;</i>
							<div class="acc-name">支付密码：</div>
							<div class="acc-txt">
								尚未开启支付密码
								<p>开启支付密码后，在使用帐户余额时需输入支付密码</p>
							</div>
							<div class="acc-btn">
								<a class="btn btn-simple btn-sm" href="/user/setpaypass">开启支付</a>
							</div></li>
						
													<li>
								<i class="jufont iconS-warn">&#xe626;</i>
								<div class="acc-name">实名认证：</div>
								<div class="acc-txt mt10">
									认证您的实名信息，提高安全等级
								</div>
								<div class="acc-btn">
									<a class="btn btn-simple btn-sm" href="/user/securealname">立即认证</a>
								</div>
							</li>
						
												<li>
							<i class="jufont iconS-warn">&#xe626;</i>
							<div class="acc-name">学生身份验证：</div>
							<div class="acc-txt mt10">
								验证学生身份，享受特惠购票
							</div>
							<div class="acc-btn">
								<a class="btn btn-simple btn-sm" href="/user/secustudent">立即验证</a>
							</div>
						</li>
												<!--青年票-->
																			<li>
							<i class="jufont iconS-warn">&#xe626;</i>
							<div class="acc-name">Young身份验证：</div>
							<div class="acc-txt mt10">完成验证，购票最惠立减50%</div>
							<div class="acc-btn">
								<a class="btn no-unl " href="/user/secuyoung">立即验证</a>
							</div>
						</li>
																	</ul>
				</div>
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        advertInfo += 'src="picture/73b9285a37f44b5c950092125787c07a.gif' + result.data.pic + '" title="' + result.data.ad_name + '" alt="' + result.data.ad_name + '" >';
                        advertInfo += '</a>';
            ...
            $.ajax({
                ...
                success:function(result)
                {
                    if(result.code == 1 && result.data)
                    {
                        ...
                        html += '<img src="picture/73b9285a37f44b5c950092125787c07a.gif' + result.data.pic + '" alt="' + result.data.ad_name + '" title="' + result.data.ad_name + '">';
                        html += '</a>';
