/*! Brian Gonzalez by jquery.adaptive-backgrounds.js 23-01-2014 */ ! function(a) {
	var b = "data-ab-color",
		c = "data-ab-parent",
	...
	! function(a) {
		...
		run: function(g) {
			...
			a(h.selector).each(function() {
				var f = a(this),
					g = function() {
						...
						RGBaster.colors(a, function(a) {
							f.attr(b, a.dominant), f.trigger(e, {
								color: a.dominant,
								palette: a.palette
							})
						}, 20)
				...
				f.on(e, function(a, b) {
					var d, e = b;
					d = i() ? f : f.attr(c) ? f.parents(f.attr(c)) : h.parent ? f.parents(h.parent) : f.parent(), d.css({
